...
<div class="row">
 ...
 <img src="IOE-library-system/img/9.jpg" alt="1" width="550" height="550" >
  ...
  <div class="col-xs-6 col-md-6">
    ...
    <form action=<?php ?>"edit/edit-exercice.php" method="post" id="loginForm">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Usage" name="Usage" required value ="<?php echo $exercices->getmyUsage();?>">
        </div>
